    ...
    >
      ...
      >
        ...
        <p className="text-sm text-[#999999] mb-6 leading-relaxed">
          <span className="font-semibold text-[#c93400]">
            {selectedLocationId}
          </span>
          {errorMessage
            ? errorMessage.split(':')[1]
            : `does not have enough seats available for `}
          <span className="font-semibold text-white">
            {guests} {guests === 1 ? 'guest' : 'guests'}
          </span>
          on
          <span className="underline decoration-[#c93400]">{selectedDate}</span>
          at this time slot.
        </p>
        ...
        <button
          ...
          onClick={() => {
            ...
            setSelectedDate(selectedLocationId, selectedDate);
          }}
