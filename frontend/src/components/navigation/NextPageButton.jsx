...
const NextPageButton = ({ to, name }) => {
  return (
    <div className="mt-8">
      <Link
        to={to}
        className="relative inline-block cursor-pointer border-2 border-white hover:border-[#c93400] rounded-full align-middle no-underline bg-transparent p-0 text-base font-inherit group learn-more w-48 h-auto"
      >
